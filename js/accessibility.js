...
const TRANSLATIONS = new Map([
  ...
  ["Selecione a forma de pagamento", "Choose a payment method"],
  ["Cartão crédito/débito", "Credit/debit card"], ["Pagar", "Pay"],
  ["Dados pessoais", "Personal details"], ["Entrega", "Delivery"],
  ["Endereço", "Address"], ["Cidade", "City"], ["Complemento", "Additional information"],
  ...
  ["Explorar catálogo", "Explore catalog"], ["Conheça o time", "Meet the team"],
  ["O universo", "The universe of"],
  ...
  ["O que nos move", "What drives us"], ["Qualidade", "Quality"],
  ["Buscamos desenvolver uma plataforma pensada pela excelência em cada detalhe.",
    "We strive to build a platform designed for excellence in every detail."],
  ["Compromisso", "Commitment"],
  ["Trabalhamos para oferecer uma experiência segura, transparente e satisfatória.",
    "We work to provide a secure, transparent and satisfying experience."],
  ["Inovação", "Innovation"],
  ...
  ["Desenvolvemos o Astra pensando em quem possui a paixão por colecionar.",
    "We built Astra for people who are passionate about collecting."],
  ["Por trás do Astra", "Behind Astra"], ["Dev back", "Back-end developer"],
